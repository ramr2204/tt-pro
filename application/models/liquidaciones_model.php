...
class Liquidaciones_model extends CI_Model {
    ...
    function getfacturas($id){
        $this->db->select('f.fact_id,f.fact_codigo, f.fact_nombre, f.fact_porcentaje, f.fact_valor, f.fact_banco, f.fact_cuenta, f.fact_rutacomprobante, pa.pago_valor, pa.pago_fecha');
