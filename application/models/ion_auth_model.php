...
class Ion_auth_model extends CI_Model
{
	...
	public function username_check($username = '')
	{
		...
		return $this->db->where('id', $username)
	...
	{
		$this->trigger_events('users_email_check');
		...
		return $this->db->where('email', $email)
		                ->count_all_results('users_emails') > 0;
	}
...
// métodos para obtener el menú y verificar permisos
  public function get_permisos($id = 0,$check_menu)
	{
		$validate=FALSE;
