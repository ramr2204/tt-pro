...
// ---------------------------------------------------------
      ...
      if ($this->ion_auth->logged_in()){
          ...
          if ($usuarioLogueado->perfilid==4){
                  ...
                  // set font
                   ...
                   $this->data['params'] = TCPDF_STATIC::serializeTCPDFtagParameters(array('www.softwareenlanube.net:8182/estampillas-pro-mike/index.php/generarpdf/generar_estampilla_QR/'.$this->uri->segment(3), 'QRCODE,H', 110, 56, 13, 13, $style, 'N'));
 ...
 function generar_estampilla_QR()
  {              
                 //Valida si la estampilla se generará para un contrato
                  //o para un trámite
                  ...
                  // set font
                   $pdf->SetFont('times', '', 8);
                   $pdf->AddPage('L',array(92,141));
                   $this->data['params'] = TCPDF_STATIC::serializeTCPDFtagParameters(array('www.softwareenlanube.net:8182/estampillas-pro-mike/index.php/generarpdf/generar_estampilla_QR/'.$this->uri->segment(3), 'QRCODE,H', 110, 57, 13, 13, $style, 'N'));
                   $html = $this->load->view('generarpdf/generarpdf_estampillalegalizada', $this->data, TRUE);  
