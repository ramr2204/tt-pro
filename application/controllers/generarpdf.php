          ...
          if ($usuarioLogueado->perfilid==4){
             ...
             //  print_r($this->data);exit();
                  ...
                  // set font
                   ...
                   $this->data['params'] = TCPDF_STATIC::serializeTCPDFtagParameters(array('http://190.85.28.74:8086/estampillas-pro/index.php/qr/q/'.$this->uri->segment(3), 'QRCODE,H', 110, 57.5, 16, 16, $style, 'T'));
