 ...
 */
$config['site_title']                 = "Sistema De Información De Estampillas PRO";       // Site Title, example.com
$config['admin_email']                = "ivandario@turrisystem.com"; // Admin Email, admin@example.com
