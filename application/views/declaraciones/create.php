        ...
        <div class="row clearfix">
            ...
            <div class="col-md-10 column">
                <div class="panel panel-default">
                    <div class="panel-heading"><h1>Generación de Declaraciones</h1></div>
                                            ...
                                            <?php
                                                foreach($estampillas as $estampilla)
                                                {
                                                    ...
                                                    <option value="<?= $estampilla->id; ?>"
                                                        <?= set_select('tipo_estampilla', $estampilla->id) ?>
                        ...
                        <?
                            if(count($consulta) > 0)
                            {
                                ...
                                <?= form_open_multipart('declaraciones/create', 'role="form"'); ?>
                                    ...
                                    <input type="hidden" name="periodo" value="<?= set_value('periodo') ?>">
                                    ...
                                    <div id="contenedor-correccion" style="display:none">
                                        ...
                                        <div class="col-md-6 column form-group">
                                            ...
                                            <input id="declaracion_correccion"
                                                ...
                                                value="<?= set_value('declaracion_correccion'); ?>"
                                                class="form-control"
                                                min="0" />
                                        ...
                                        <div class="col-md-6 column form-group">
                                            ...
                                            <input id="radicacion_correccion"
                                                ...
                                                value="<?= set_value('radicacion_correccion'); ?>"
                                                class="form-control"
                                                min="0" />
                                        ...
                                        <div class="col-md-6 column form-group">
                                            ...
                                            <input type='text'
                                                ...
                                                id="fecha_correccion"
                                                value="<?= set_value('fecha_correccion'); ?>"
                                                autocomplete="off"
                                            />
                                        ...
                                        <div class="col-md-6 column form-group">
                                            ...
                                            <input type='text'
                                                ...
                                                value="<?= set_value('periodo_correccion'); ?>"
                                                autocomplete="off"
                                            />
                                    ...
                                    <div>
                                        ...
                                        <div class="col-md-6 column form-group">
                                            ...
                                            <input id="saldo_periodo_anterior"
                                                ...
                                                value="<?= set_value('saldo_periodo_anterior'); ?>"
                                                class="form-control"
                                                required="required"
                                                min="0" />
                                        ...
                                        <div class="col-md-6 column form-group">
                                            ...
                                            <input id="sanciones_pago"
                                                type="number"
                                                name="sanciones_pago"
                                                value="<?= set_value('sanciones_pago'); ?>"
                                                class="form-control"
                                                required="required"
                                                min="0" />
                                        ...
                                        <div class="col-md-6 column form-group">
                                            ...
                                            <input id="intereses_mora"
                                                type="number"
                                                name="intereses_mora"
                                                value="<?= set_value('intereses_mora'); ?>"
                                                class="form-control"
                                                required="required"
                                                min="0" />
