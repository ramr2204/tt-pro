            ...
            <thead>
                <tr>
                    <th colspan="1" class="text-center small">
                        <img src="<?php echo $this->config->item('application_root'); ?>/images/gobernacion_cauca1.jpg" height="60" width="70" >
                    </th>
                    <th colspan="2" class="text-center small">Gobernación del Cauca <br> Secretaría de Hacienda Departamental <br> Oficina Rentas</th>
                    <th colspan="1" class="text-center small">
                        <img src="<?php echo $this->config->item('application_root'); ?>/images/gobernacion_cauca2.png" height="50" width="90" >
                    </th>
                </tr>
            </thead>
            <tbody>
