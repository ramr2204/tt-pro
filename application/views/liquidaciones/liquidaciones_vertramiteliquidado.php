...
<div class="row"> 
 ...
 <thead>
    <tr>
     ...
     <th colspan="3" class="text-center small" width="60%">Gobernación de Boyacá <br> Departamento Administrativo de Asuntos Jurídicos <br> Dirección de Contratación</th>
     <th colspan="1" class="text-center small" width="20%">
