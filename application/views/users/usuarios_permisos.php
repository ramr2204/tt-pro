...
<h1><?php echo $result->email; ?> - Editar permisos del usuario</h1>
...
"bProcessing": true,
"bServerSide": true,
"sAjaxSource": "<?php echo base_url(); ?>index.php/users/permisos_datatable/<?php echo $result->id; ?>",
"sServerMethod": "POST",
"aoColumns": [ 
  ...
  "fnDrawCallback": function( oSettings ) {
             ...
             $(".message").load("<?php echo base_url(); ?>index.php/users/predeterminar", {id_menu: ID, id_usuario:<?php echo $result->id; ?>}, function(){
                oTable.fnDraw();  
              });
             ...
             var IDP = $(this).attr("id");
              $(".message").append('<i class="fa fa-spinner fa-spin"></i>');
              $(".message").load("<?php echo base_url(); ?>index.php/users/despredeterminar", {id_permiso: IDP}, function(){
                oTable.fnDraw();
              });
