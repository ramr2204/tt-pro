...
*   Descripcion:       tabla que mustra todos los modulos existentes
...
"bProcessing": true,
"bServerSide": true,
"sAjaxSource": "<?php echo base_url(); ?>index.php/modulos/dataTable",
"sServerMethod": "POST",
"aoColumns": [ 
...
<div class="row"> 
 <div class="col-sm-12">    
  ...
  if ($this->ion_auth->is_admin())
      {
        echo anchor(base_url().'modulos/add','<i class="fa fa-plus"></i> Nuevo módulo ','class="btn btn-large  btn-primary"');
      }
  ?>
   <br><br> 
