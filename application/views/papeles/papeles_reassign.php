                            ...
                            <div class="panel-heading"><h1>Reasignación de  papelería para estampillas</h1></div>
                             <div class="panel-body">
                              <?php echo form_open('papeles_postReassign'); ?>
                                    ...
                                    <button id="btn_save" type="submit" class="btn btn-success"><i class="fa fa-floppy-o"></i> Guardar</button>
                                    </div>
                                <?php echo form_close();?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Usuario con varios Rangos Disponibles</h4>
      </div>
      <div class="modal-body" id="rangos">
